...
class Registerfirst(models.Model):
    ...
    remail = models.EmailField(null=True, blank=True)
    rphone = models.CharField(max_length=20, null=True, blank=True)
    rqualification = models.CharField(max_length=20, null=True, blank=True)
